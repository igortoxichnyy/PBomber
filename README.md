...
<p>Проект создания бомбера на Python я обьявляю заброшенным. Я начал изучать JS, т.к. испытываю выгорание к Python. В будущем я буду переписывать данный проект на JS.</p>
