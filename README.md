<h2>ПРОЕКТ ЗАБРОШЕН!</h2>

<p>Проект создания бомбера на Python я обьявляю заброшенным. Я начал изучать Java, т.к. испытываю выгорание к Python. В будущем я буду переписывать данный проект на Java.</p>
